...
#include "EditSequencerTracksTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UEditSequencerTracksTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("edit-sequencer-tracks"); }
