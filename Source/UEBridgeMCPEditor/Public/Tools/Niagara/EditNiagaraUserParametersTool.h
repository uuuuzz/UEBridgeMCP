...
#include "EditNiagaraUserParametersTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UEditNiagaraUserParametersTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("edit-niagara-user-parameters"); }
