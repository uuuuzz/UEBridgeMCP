...
#include "WorldPartitionEditTools.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UEditWorldPartitionCellsTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("edit-worldpartition-cells"); }
