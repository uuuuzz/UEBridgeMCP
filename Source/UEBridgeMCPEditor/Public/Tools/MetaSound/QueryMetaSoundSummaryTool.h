...
#include "QueryMetaSoundSummaryTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UQueryMetaSoundSummaryTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("query-metasound-summary"); }
