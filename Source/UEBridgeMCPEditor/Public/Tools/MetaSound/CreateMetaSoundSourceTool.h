...
#include "CreateMetaSoundSourceTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UCreateMetaSoundSourceTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("create-metasound-source"); }
