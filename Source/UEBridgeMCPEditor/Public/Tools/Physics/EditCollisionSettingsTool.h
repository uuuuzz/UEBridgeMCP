...
#include "EditCollisionSettingsTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UEditCollisionSettingsTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("edit-collision-settings"); }
