...
#include "CreatePhysicsConstraintTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UCreatePhysicsConstraintTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("create-physics-constraint"); }
