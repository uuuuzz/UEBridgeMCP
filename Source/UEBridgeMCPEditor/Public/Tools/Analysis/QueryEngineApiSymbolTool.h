...
#include "QueryEngineApiSymbolTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UQueryEngineApiSymbolTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("query-engine-api-symbol"); }
