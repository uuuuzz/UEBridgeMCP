...
#include "GenerateLevelPatternTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UGenerateLevelPatternTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("generate-level-pattern"); }
	virtual FString GetToolDescription() const override;
	virtual TMap<FString, FMcpSchemaProperty> GetInputSchema() const override;
	virtual TArray<FString> GetRequiredParams() const override { return { TEXT("pattern") }; }
