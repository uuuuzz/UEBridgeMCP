...
#include "SourceControlAssetsTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API USourceControlAssetsTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("source-control-assets"); }
