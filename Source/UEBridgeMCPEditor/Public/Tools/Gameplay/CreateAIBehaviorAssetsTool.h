...
#include "CreateAIBehaviorAssetsTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UCreateAIBehaviorAssetsTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("create-ai-behavior-assets"); }
