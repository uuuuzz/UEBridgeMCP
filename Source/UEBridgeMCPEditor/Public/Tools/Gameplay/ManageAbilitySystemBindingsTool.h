...
#include "ManageAbilitySystemBindingsTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UManageAbilitySystemBindingsTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("manage-ability-system-bindings"); }
