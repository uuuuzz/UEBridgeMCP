...
#include "CreateGameplayEffectTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UCreateGameplayEffectTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("create-gameplay-effect"); }
