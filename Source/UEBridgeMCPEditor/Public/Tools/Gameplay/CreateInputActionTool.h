...
#include "CreateInputActionTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UCreateInputActionTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("create-input-action"); }
