...
#include "CreateGameplayAbilityTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UCreateGameplayAbilityTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("create-gameplay-ability"); }
