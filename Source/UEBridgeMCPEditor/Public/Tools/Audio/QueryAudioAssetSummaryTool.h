...
#include "QueryAudioAssetSummaryTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UQueryAudioAssetSummaryTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("query-audio-asset-summary"); }
