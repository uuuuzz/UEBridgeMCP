...
#include "ApplyAudioToActorTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UApplyAudioToActorTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("apply-audio-to-actor"); }
	virtual FString GetToolDescription() const override;
	virtual TMap<FString, FMcpSchemaProperty> GetInputSchema() const override;
	virtual TArray<FString> GetRequiredParams() const override { return { TEXT("sound_path") }; }
