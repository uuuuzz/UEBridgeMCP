...
TMap<FString, FMcpSchemaProperty> UQueryMaterialTool::GetInputSchema() const
{
...
FMcpToolResult UQueryMaterialTool::Execute(
	...
	const FMcpToolContext& Context)
{
	...
	UE_LOG(LogUEBridgeMCP, Log, TEXT("query-material: path='%s', include='%s'"), *AssetPath, *Include);
