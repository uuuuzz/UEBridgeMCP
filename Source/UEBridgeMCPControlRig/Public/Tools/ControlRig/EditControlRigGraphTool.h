...
#include "EditControlRigGraphTool.generated.h"

UCLASS()
class UEBRIDGEMCPCONTROLRIG_API UEditControlRigGraphTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("edit-control-rig-graph"); }
