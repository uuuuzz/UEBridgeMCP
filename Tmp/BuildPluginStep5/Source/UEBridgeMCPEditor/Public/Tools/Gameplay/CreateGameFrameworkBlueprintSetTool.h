...
#include "CreateGameFrameworkBlueprintSetTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UCreateGameFrameworkBlueprintSetTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("create-gameframework-blueprint-set"); }
