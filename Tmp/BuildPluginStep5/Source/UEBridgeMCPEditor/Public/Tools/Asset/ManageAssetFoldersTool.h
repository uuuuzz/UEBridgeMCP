...
#include "ManageAssetFoldersTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UManageAssetFoldersTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("manage-asset-folders"); }
