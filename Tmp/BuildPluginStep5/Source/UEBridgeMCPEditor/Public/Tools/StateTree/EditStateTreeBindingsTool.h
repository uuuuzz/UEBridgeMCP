...
#include "EditStateTreeBindingsTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UEditStateTreeBindingsTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("edit-statetree-bindings"); }
