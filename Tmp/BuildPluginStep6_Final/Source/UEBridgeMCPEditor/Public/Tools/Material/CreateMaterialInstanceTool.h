...
#include "CreateMaterialInstanceTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UCreateMaterialInstanceTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("create-material-instance"); }
