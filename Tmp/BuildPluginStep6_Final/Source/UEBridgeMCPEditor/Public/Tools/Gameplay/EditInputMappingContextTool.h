...
#include "EditInputMappingContextTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UEditInputMappingContextTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("edit-input-mapping-context"); }
