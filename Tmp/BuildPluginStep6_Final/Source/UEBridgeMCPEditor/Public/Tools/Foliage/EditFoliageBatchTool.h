...
#include "EditFoliageBatchTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UEditFoliageBatchTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("edit-foliage-batch"); }
