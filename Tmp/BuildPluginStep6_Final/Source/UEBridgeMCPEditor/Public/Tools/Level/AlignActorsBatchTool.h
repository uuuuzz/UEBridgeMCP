...
#include "AlignActorsBatchTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UAlignActorsBatchTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("align-actors-batch"); }
	virtual FString GetToolDescription() const override;
	virtual TMap<FString, FMcpSchemaProperty> GetInputSchema() const override;
	virtual TArray<FString> GetRequiredParams() const override { return { TEXT("actors"), TEXT("axis"), TEXT("mode") }; }
