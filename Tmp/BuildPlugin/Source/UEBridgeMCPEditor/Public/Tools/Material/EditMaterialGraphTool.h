...
#include "EditMaterialGraphTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UEditMaterialGraphTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("edit-material-graph"); }
