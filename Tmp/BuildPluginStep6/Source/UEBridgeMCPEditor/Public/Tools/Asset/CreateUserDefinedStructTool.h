...
#include "CreateUserDefinedStructTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UCreateUserDefinedStructTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("create-user-defined-struct"); }
