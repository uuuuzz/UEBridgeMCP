...
#include "ReplaceStaticMeshTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UReplaceStaticMeshTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("replace-static-mesh"); }
