...
#include "CreateInputMappingContextTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UCreateInputMappingContextTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("create-input-mapping-context"); }
