...
#include "EditReplicationSettingsTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UEditReplicationSettingsTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("edit-replication-settings"); }
