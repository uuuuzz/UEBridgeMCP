...
#include "EditMaterialInstanceBatchTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UEditMaterialInstanceBatchTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("edit-material-instance-batch"); }
