...
#include "CreateUserDefinedEnumTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UCreateUserDefinedEnumTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("create-user-defined-enum"); }
