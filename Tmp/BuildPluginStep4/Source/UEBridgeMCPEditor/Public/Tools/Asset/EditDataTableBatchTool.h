...
#include "EditDataTableBatchTool.generated.h"

UCLASS()
class UEBRIDGEMCPEDITOR_API UEditDataTableBatchTool : public UMcpToolBase
{
	GENERATED_BODY()

public:
	virtual FString GetToolName() const override { return TEXT("edit-datatable-batch"); }
